...
WITH
harvest AS (
    SELECT CUSTOMER_HK, CUSTOMER_BK, LOAD_DTS, REC_SRC
...
ghost_records AS (
    SELECT MD5_BINARY(UPPER('0'))  AS CUSTOMER_HK, '0'  AS CUSTOMER_BK, '1900-01-01T00:00:00'::TIMESTAMP_NTZ AS LOAD_DTS, 'SYSTEM' AS REC_SRC
    UNION ALL
